...
<body class="bg-gray-50 min-h-screen flex flex-col">
    ...
    <nav class="absolute top-0 left-0 w-full z-50 py-6 px-6 md:px-12 flex justify-between items-center text-white">
        <div class="flex items-center gap-8">
            ...
            <div class="hidden lg:flex gap-6 font-semibold tracking-wide">
                ...
                <span class="border-b-2 border-white pb-1">Surat Pengantar</span>
            </div>
        </div>
    ...
    <section class="relative bg-gradient-to-r from-[#c09015] via-[#d4a017] to-[#fcd34d] pt-32 pb-40 text-center">
        ...
        <div class="fade-up opacity-0 translate-y-8 transition-all duration-700">
            <h1 class="text-white text-3xl md:text-4xl font-extrabold mb-2 drop-shadow-md">Pengajuan Surat Pengantar</h1>
            <p class="text-white/90 font-medium">Layanan mandiri pembuatan surat pengantar administrasi RT</p>
        </div>
    ...
    <section class="relative z-20 -mt-24 px-4 pb-20 max-w-3xl mx-auto w-full flex-grow">
        <div class="fade-up opacity-0 translate-y-12 transition-all duration-700 delay-100 bg-white rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.06)] p-8 border border-gray-100">
            ...
            <div class="mb-6 border-b border-gray-100 pb-4">
                ...
                <p class="text-sm text-gray-500 mt-1 font-medium">Surat akan diproses oleh ketua RT maksimal 1x24 Jam.</p>
            </div>

            <form class="space-y-6">
                <div>
                    <label class="block text-gray-700 text-xs font-bold mb-2 uppercase tracking-wide">Nama Lengkap Pemohon</label>
                    <input type="text" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#d4a017] outline-none transition-all" placeholder="Masukkan nama sesuai KTP">
                </div>
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-gray-700 text-xs font-bold mb-2 uppercase tracking-wide">NIK KTP</label>
                        <input type="number" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#d4a017] outline-none transition-all" placeholder="16 Digit NIK">
                    </div>
                    <div>
                        <label class="block text-gray-700 text-xs font-bold mb-2 uppercase tracking-wide">Blok / No Rumah</label>
                        <input type="text" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#d4a017] outline-none transition-all" placeholder="Blok ... No ...">
                    </div>
                </div>

                <div>
                    <label class="block text-gray-700 text-xs font-bold mb-2 uppercase tracking-wide">Jenis Surat Pengantar</label>
                    <select class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#d4a017] outline-none transition-all text-gray-700 font-medium">
                        <option>Pilih jenis surat...</option>
                        <option>Surat Keterangan Domisili</option>
                        <option>Surat Pengantar Pembuatan KK/KTP</option>
                        <option>Surat Keterangan Tidak Mampu (SKTM)</option>
                        <option>Surat Izin Usaha di Lingkungan RT</option>
                    </select>
                </div>

                <div>
                    <label class="block text-gray-700 text-xs font-bold mb-2 uppercase tracking-wide">Alasan Permohonan / Keperluan</label>
                    <textarea rows="4" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#d4a017] outline-none transition-all" placeholder="Jelaskan secara singkat kegunaan surat ini..."></textarea>
                </div>

                <button type="button" class="w-full bg-gray-900 text-white font-bold py-4 rounded-xl hover:bg-[#d4a017] transition-colors tracking-widest text-sm mt-4">
                    KIRIM PERMOHONAN
                </button>
            </form>
